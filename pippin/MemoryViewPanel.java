...
public class MemoryViewPanel implements Observer{
	...
	JTextField[] dataDecimal = new JTextField[Memory.DATA_SIZE];
	JTextField[] dataHex  = new JTextField[Memory.DATA_SIZE];
	int lower, upper, previousColor = -1;
	
	public MemoryViewPanel(MachineView mv, int low, int high){
		machineView = mv;
		lower = low;
		upper = high;
