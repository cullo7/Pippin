...
public class InstructionTest {
	...
	public void testImmediateFOR() {
		...
		machine.setCode(0,0);
		machine.setCode(0,0);
		machine.setCode(0x11, 0x1);
		machine.setCode(0x2b, 0x1);
		machine.setCode(0x14, 0x1);
		//dat equivalent
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals(machine.getPC(), 5);
	}

	@Test
	// Check CMPZ when comparing greater than 0 gives false
	public void testDirectFOR() {
		Instruction instr = machine.get(0xD);
		//pexe equivalent
		machine.setAccum(3);
		machine.setPC(1);
